...
//Chnge test1
		...
		String[][] GameType = {{image1, image2, image3, image4, image5,Fbutton, image6, image7,image8,image9,image10,Fbutton,image11,image12,image13,image14,image15},{BSection}};
		System.out.println(GameType[0][0] + GameType[1][0]); // Mrs. Kumar 
		System.out.println(GameType[0][1] + GameType[1][0]); 
		System.out.println(GameType[0][2] + GameType[1][0]);
		
		
//		String[][] salutation = { {"Mr. ", "Mrs. ", "Ms. "}, {"Kumar"} }; // Mr. Kumar 
//		System.out.println(salutation[0][0] + salutation[1][0]); // Mrs. Kumar 
